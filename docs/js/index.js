...
function onClickImage(element) {
    document.getElementById(element.id + "-Panel-Parent").style.display = "block";
}
function onCloseImage(element) {
    document.getElementById(element.id + "-Parent").style.display = "none";
}
